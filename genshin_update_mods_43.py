...
# 4.1 Version Credits:
# Huge thank you to Donat, annplan, Zlevir, Cybertron, LeoMods, Yorucchi and vp000 for collecting the hashes!
# Thanks Nurarihyon for v5 backwards compatibility, and LeoMods for compiling the changes and writing the V2 script

# 4.3 Version Credits:
# Huge thank you to LeoMods, Cybertron, Zlevir, Donat, Astute, SinsOfSeven, Gustav0 for collecting the hashes!

# >_> This script is getting a bit messy. If mods break again, I'll have to generalize it
    ...
    for ini_file in ini_files:
        try:
            ...
            with open(os.path.join(folder_path, ini_file), "r+", encoding="utf-8") as f:
                ...
                # 4.1 Fix
                matching = [x for x in old_hashes_vb_41 if x in data] or [x for x in postionhashes_41 if x in data]

                if len(matching) < 1:
                    print("\tVB Hash not recognized")

                for match in matching:
                    if match in oldvsnew_41 and oldvsnew_41[match] not in data:
                        print("\tUpdating ini for 4.1")
                        with open(os.path.join(folder_path,"DISABLED_Backup_41"+ os.path.splitext(ini_file)[0] + ".txt",),"w",encoding="utf-8",) as g:
                            g.write(data)
                        data += f"\n\n; 4.1 Character Fix \n[TextureOverride41FixVertexLimitRaise{counter}]\nhash = {oldvsnew_41[match]}\nmatch_priority = 1"
                        counter += 1
                    elif (match in DetermineCharacterBasedOnPositionHash_41 and DetermineCharacterBasedOnPositionHash_41[match] not in data):
                            print("\tUpdating ini for 4.1")
                            with open(os.path.join(folder_path, "DISABLED_Backup_41"+ os.path.splitext(ini_file)[0]+ ".txt", ),"w",encoding="utf-8",) as g:
                                g.write(data)
                        ...
                        print("\tIni has already been updated for 4.1")

                # 4.3 Fix
                matching = [x for x in old_hashes_ib_43 if str(x) in data] or [x for x in new_hashes_ib_43 if str(x) in data]

                if len(matching) < 1:
                    print("\tIB Hash not recognized")

                for match in matching:

                    if match in oldvsnew_43 and oldvsnew_43[match] not in data:
                        print("\tUpdating ini for 4.3")

                        with open(os.path.join(folder_path, "DISABLED_Backup_43" + os.path.splitext(ini_file)[0] + ".txt", ), "w", encoding="utf-8", ) as g:
                            g.write(data)

                        # Too complex to use the same method as 4.1 here, we have to actually replace the IB line
                        output = ""
...
alljson_41 = [
    ...
    #    "new_draw_vb": "22d5afb4",
    #    "path": "./EnemyData/AbyssLectorCryo/hash.json",
    #    "folder": "./EnemyData/AbyssLectorCryo",
    #    "component_name": "2",
    # },
    #{
    #    "position_vb": "385d2fad",
    #    "old_draw_vb": "16e5380a",
    #    "new_draw_vb": "22d5afb4",
    #    "path": "./EnemyData/AbyssLectorHydro/hash.json",
    #    "folder": "./EnemyData/AbyssLectorHydro",
    #    "component_name": "2",
    #},
    {
        "position_vb": "385d2fad",
...
alljson_43 = [
    {
        "old_ib": "20f5e761",
        "texcoord_vb": "67561b21",
        "blend_vb": "ce5d3779",
        "position_vb": "c0a7c1b0",
        "draw_vb": "20f5e761",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/AbyssHerald/hash.json",
        ...
        "old_ib": "cd59deec",
        "texcoord_vb": "de56c88b",
        "blend_vb": "e93042c7",
        "position_vb": "3a4a86b5",
        "draw_vb": "cd59deec",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/AbyssLectorElectro/hash.json",
        "folder": "./EnemyData/AbyssLectorElectro",
        "component_name": "",
        "name": "AbyssLectorElectro"
    }, {
        "old_ib": "16e5380a",
        "texcoord_vb": "787dd47d",
        "blend_vb": "3af7c1f3",
        "position_vb": "385d2fad",
        "draw_vb": "16e5380a",
        "new_ib": "",
        ...
        "old_ib": "3081295f",
        "texcoord_vb": "bb2a091f",
        "blend_vb": "02b57d02",
        "position_vb": "b5c980c9",
        "draw_vb": "3081295f",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/AbyssLectorPyro/hash.json",
        "folder": "./EnemyData/AbyssLectorPyro",
        "component_name": "",
        "name": "AbyssLectorPyro"
    }, {
        "old_ib": "3e3f6114",
        "texcoord_vb": "df8da417",
        "blend_vb": "e97c9fee",
        "position_vb": "6db3d14e",
        "draw_vb": "3e3f6114",
        "new_ib": "",
        ...
        "old_ib": "4f5a6086",
        "texcoord_vb": "d8d32b82",
        "blend_vb": "f6d811e6",
        "position_vb": "1385be5b",
        "draw_vb": "4f5a6086",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/Andrius/hash.json",
        ...
        "old_ib": "a0057feb",
        "texcoord_vb": "9121a30d",
        "blend_vb": "e3f05208",
        "position_vb": "ab3498b2",
        "draw_vb": "a0057feb",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/Azhdaha/hash.json",
        ...
        "old_ib": "5f4f7a04",
        "texcoord_vb": "5a076aba",
        "blend_vb": "057472dc",
        "position_vb": "669a8933",
        "draw_vb": "62b1d836",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/BigSlimeDendro/hash.json",
        ...
        "old_ib": "5d4bd489",
        "texcoord_vb": "8a2e24e2",
        "blend_vb": "f551c131",
        "position_vb": "62a4f1dd",
        "draw_vb": "3c254382",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/BigSlimeDendro/hash.json",
        ...
        "folder": "./EnemyData/BlackSerpentKnightRockBreakerAx",
        "component_name": "",
        "name": "BlackSerpentKnightRockBreakerAx"
    }, {
        "old_ib": "7fd2dc62",
        "texcoord_vb": "ee82eed3",
        "blend_vb": "e6659507",
        "position_vb": "e063a51f",
        "draw_vb": "5db509de",
        "new_ib": "",
        ...
        "folder": "./EnemyData/BlackSerpentWindcutter",
        "component_name": "",
        "name": "BlackSerpentWindcutter"
    }, {
        "old_ib": "3e69e391",
        "texcoord_vb": "b60ab114",
        "blend_vb": "7a753bf4",
        "position_vb": "81f659d4",
        "draw_vb": "a084aab0",
        "new_ib": "06bd894e",
        ...
        "old_ib": "5ae75c8d",
        "texcoord_vb": "b2d1a7c7",
        "blend_vb": "",
        "position_vb": "8fc44e04",
        "draw_vb": "8fc44e04",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/CryoHypostasis/hash.json",
        ...
        "old_ib": "11247279",
        "texcoord_vb": "7448070c",
        "blend_vb": "627c110c",
        "position_vb": "520ec260",
        "draw_vb": "11247279",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/Dvalin/hash.json",
        ...
        "old_ib": "4147f32b",
        "texcoord_vb": "ac90d656",
        "blend_vb": "",
        "position_vb": "1ab48063",
        "draw_vb": "1ab48063",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/ElectroHypostasis/hash.json",
        "folder": "./EnemyData/ElectroHypostasis",
        "component_name": "",
        "name": "ElectroHypostasis"
    }, {
        "old_ib": "3dbb0e08",
        "texcoord_vb": "26d65367",
        "blend_vb": "",
        "position_vb": "9602d5d1",
        "draw_vb": "9602d5d1",
        "new_ib": "",
        ...
        "old_ib": "11c94b2a",
        "texcoord_vb": "bf230afe",
        "blend_vb": "ec0726ec",
        "position_vb": "735cceaa",
        "draw_vb": "702b5e36",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/ElectroRegisvine/hash.json",
        "folder": "./EnemyData/ElectroRegisvine",
        "component_name": "",
        "name": "ElectroRegisvine"
    }, {
        "old_ib": "704e68cf",
        "texcoord_vb": "6fc1c0d2",
        "blend_vb": "5491c425",
        "position_vb": "fd8c7613",
        "draw_vb": "4e619233",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/ElectroRegisvine/hash.json",
        ...
        "old_ib": "637cda49",
        "texcoord_vb": "cfc631ea",
        "blend_vb": "69cadec8",
        "position_vb": "a6fc3978",
        "draw_vb": "20210b4b",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/ElectroRegisvine/hash.json",
        ...
        "old_ib": "6788cef6",
        "texcoord_vb": "6d8e4639",
        "blend_vb": "741ae929",
        "position_vb": "0fdbc3cd",
        "draw_vb": "a3b91deb",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/ElectroRegisvine/hash.json",
        ...
        "old_ib": "0cb832e3",
        "texcoord_vb": "a06055f8",
        "blend_vb": "5b606232",
        "position_vb": "3b509a24",
        "draw_vb": "9cc12f87",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/ElectroRegisvine/hash.json",
        ...
        "old_ib": "c24fce2a",
        "texcoord_vb": "12d97120",
        "blend_vb": "c2f479f5",
        "position_vb": "ce00cdce",
        "draw_vb": "941080a1",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/ElectroRegisvine/hash.json",
        ...
        "folder": "./EnemyData/EremiteFloralRingDancer",
        "component_name": "",
        "name": "EremiteFloralRingDancer"
    }, {
        "old_ib": "805be8c0",
        "texcoord_vb": "7f2a0698",
        "blend_vb": "f68da44f",
        "position_vb": "23d51a03",
        "draw_vb": "c585c3fb",
        "new_ib": "",
        ...
        "old_ib": "049a02cd",
        "texcoord_vb": "f848fc09",
        "blend_vb": "40365e57",
        "position_vb": "5ebcce10",
        "draw_vb": "ee618640",
        "new_ib": "3c4e6812",
        "new_draw_vb": "",
        "path": "./EnemyData/FatuiElectroCicinMage/hash.json",
        "folder": "./EnemyData/FatuiElectroCicinMage",
        "component_name": "",
        "name": "FatuiElectroCicinMage"
    }, {
        "old_ib": "82d9825b",
        "texcoord_vb": "cc04c98d",
        "blend_vb": "40365e57",
        "position_vb": "f29b3fab",
        "draw_vb": "f29b3fab",
        "new_ib": "06bd894e",
        ...
        "folder": "./EnemyData/FatuiMirrorMaiden",
        "component_name": "",
        "name": "FatuiMirrorMaiden"
    }, {
        "old_ib": "c943e59e",
        "texcoord_vb": "bc17c899",
        "blend_vb": "b2b0ff45",
        "position_vb": "23c24723",
        "draw_vb": "3313003d",
        "new_ib": "f1978f41",
        ...
        "folder": "./EnemyData/HilicurlRangerHydro",
        "component_name": "",
        "name": "HilicurlRangerHydro"
    }, {
        "old_ib": "2383d1ff",
        "texcoord_vb": "e658f790",
        "blend_vb": "0e0ae559",
        "position_vb": "ecda2927",
        "draw_vb": "70cc2de5",
        "new_ib": "",
        ...
        "old_ib": "71c4f64a",
        "texcoord_vb": "63492b53",
        "blend_vb": "3aca49d2",
        "position_vb": "5fa08319",
        "draw_vb": "71c4f64a",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/LaSignoraHarbingers/hash.json",
        "folder": "./EnemyData/LaSignoraHarbingers",
        "component_name": "",
        "name": "LaSignoraHarbingers"
    }, {
        "old_ib": "0dcd3f88",
        "texcoord_vb": "ddf59101",
        "blend_vb": "c7b91bbe",
        "position_vb": "0a894825",
        "draw_vb": "0dcd3f88",
        "new_ib": "",
        ...
        "old_ib": "e7247034",
        "texcoord_vb": "e3511425",
        "blend_vb": "57788910",
        "position_vb": "b9040c78",
        "draw_vb": "e7247034",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/MagatsuMitakeNarukaminoMikoto/hash.json",
        "folder": "./EnemyData/MagatsuMitakeNarukaminoMikoto",
        "component_name": "",
        "name": "MagatsuMitakeNarukaminoMikoto"
    }, {
        "old_ib": "7274a9ef",
        "texcoord_vb": "e74ed52a",
        "blend_vb": "c563d645",
        "position_vb": "0fad4398",
        "draw_vb": "7274a9ef",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./EnemyData/MagatsuMitakeNarukaminoMikoto/hash.json",
        ...
        "folder": "./EnemyData/TartagliaDelusion",
        "component_name": "",
        "name": "TartagliaDelusion"
    }, {
        "old_ib": "45404603",
        "texcoord_vb": "e0312660",
        "blend_vb": "2dba6d5e",
        "position_vb": "09eccc99",
        "draw_vb": "45404603",
        "new_ib": "",
        ...
        "folder": "./MiscellaneousData/AranaraFlowerCrown",
        "component_name": "",
        "name": "AranaraFlowerCrown"
    }, {
        "old_ib": "090cc533",
        "texcoord_vb": "f1c2ba7a",
        "blend_vb": "8635a7e9",
        "position_vb": "be82fa92",
        "draw_vb": "19ca0e6e",
        "new_ib": "",
        ...
        "folder": "./MiscellaneousData/CryoCicinMageLatern",
        "component_name": "",
        "name": "CryoCicinMageLatern"
    }, {
        "old_ib": "c2d0f4c4",
        "texcoord_vb": "65783aa7",
        "blend_vb": "2ee0b752",
        "position_vb": "c426a5b3",
        "draw_vb": "7e46ac01",
        "new_ib": "",
        ...
        "folder": "./MiscellaneousData/LisaStudentBook",
        "component_name": "",
        "name": "LisaStudentBook"
    }, {
        "old_ib": "c6a138bd",
        "texcoord_vb": "29c80aa7",
        "blend_vb": "908b5498",
        "position_vb": "600d512d",
        "draw_vb": "e60a7404",
        "new_ib": "",
        ...
        "folder": "./MiscellaneousData/TheSevenBarbatos",
        "component_name": "",
        "name": "TheSevenBarbatos"
    }, {
        "old_ib": "6480d788",
        "texcoord_vb": "35aa072d",
        "blend_vb": "6217dacc",
        "position_vb": "ed9d64fb",
        "draw_vb": "90239f6d",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./MiscellaneousData/TheSevenBarbatos/hash.json",
        ...
        "old_ib": "f4e8e4b1",
        "texcoord_vb": "e32074e9",
        "blend_vb": "",
        "position_vb": "6b773d7d",
        "draw_vb": "6b773d7d",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./NPCData/DainsleifFace/hash.json",
        ...
        "old_ib": "80889fe9",
        "texcoord_vb": "0b54338b",
        "blend_vb": "",
        "position_vb": "23ea1a97",
        "draw_vb": "23ea1a97",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./NPCData/DainsleifFace/hash.json",
        ...
        "old_ib": "669be7b7",
        "texcoord_vb": "2e55ba6b",
        "blend_vb": "e0e4a1f0",
        "position_vb": "27e42ea9",
        "draw_vb": "12c26e65",
        "new_ib": "5e4f8d68",
        "new_draw_vb": "",
        "path": "./NPCData/Furina(NPC) pre4-2/hash.json",
        "folder": "./NPCData/Furina(NPC) pre4-2",
        "component_name": "Ponytail",
        ...
        "old_ib": "c5c4cc9f",
        "texcoord_vb": "16b993ea",
        "blend_vb": "303475e7",
        "position_vb": "694fe006",
        "draw_vb": "fe8c5551",
        "new_ib": "f347490e",
        "new_draw_vb": "",
        "path": "./NPCData/Katheryne/hash.json",
        ...
        "old_ib": "b2c5a4e3",
        "texcoord_vb": "8512d793",
        "blend_vb": "",
        "position_vb": "0827d39a",
        "draw_vb": "0827d39a",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./NPCData/LaSignoraFace/hash.json",
        ...
        "old_ib": "04814b8d",
        "texcoord_vb": "9cfb4d2e",
        "blend_vb": "",
        "position_vb": "922ca16d",
        "draw_vb": "922ca16d",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./NPCData/LaSignoraFace/hash.json",
        ...
        "old_ib": "3f6d614c",
        "texcoord_vb": "336d3b4b",
        "blend_vb": "",
        "position_vb": "2c2887f2",
        "draw_vb": "2c2887f2",
        "new_ib": "07b90b93",
        "new_draw_vb": "",
        "path": "./NPCData/Octobaby/hash.json",
        "folder": "./NPCData/Octobaby",
        "component_name": "Bubble",
        "name": "Octobaby"
    }, {
        "old_ib": "3633dea5",
        "texcoord_vb": "5b80dde9",
        "blend_vb": "02832c24",
        "position_vb": "7b27c015",
        "draw_vb": "78a65dfd",
        "new_ib": "0ee7b47a",
        "new_draw_vb": "",
        "path": "./NPCData/Octobaby/hash.json",
        ...
        "old_ib": "a1a35456",
        "texcoord_vb": "f4deb17d",
        "blend_vb": "18c433ba",
        "position_vb": "99cad7f0",
        "draw_vb": "e26b6048",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./NPCData/Scaramouche/hash.json",
        ...
        "old_ib": "6a2142f1",
        "texcoord_vb": "f9ecba88",
        "blend_vb": "",
        "position_vb": "3907f0cd",
        "draw_vb": "3907f0cd",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./NPCData/ScaramoucheFace/hash.json",
        "folder": "./NPCData/ScaramoucheFace",
        "component_name": "",
        "name": "ScaramoucheFace"
    }, {
        "old_ib": "695dcf0d",
        "texcoord_vb": "290d70c3",
        "blend_vb": "",
        "position_vb": "e7c168cf",
        "draw_vb": "e7c168cf",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./NPCData/ScaramoucheFace/hash.json",
        ...
        "old_ib": "70db78b8",
        "texcoord_vb": "a75e7052",
        "blend_vb": "344f5b7b",
        "position_vb": "cf66bef6",
        "draw_vb": "970e7336",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./PlayerCharacterData/Arlecchino/hash.json",
        "folder": "./PlayerCharacterData/Arlecchino",
        "component_name": "",
        "name": "Arlecchino"
    }, {
        "old_ib": "347bb8f8",
        "texcoord_vb": "0c7e5f66",
        "blend_vb": "3d534190",
        "position_vb": "0107925f",
        "draw_vb": "9d2c1c5d",
        "new_ib": "0cafd227",
        ...
        "old_ib": "e6633da7",
        "texcoord_vb": "6f92a8d5",
        "blend_vb": "2408f3d5",
        "position_vb": "ec4d64c9",
        "draw_vb": "127d2fe8",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./PlayerCharacterData/Charlotte/hash.json",
        ...
        "old_ib": "6bc9f987",
        "texcoord_vb": "7e7aeada",
        "blend_vb": "fff25ec8",
        "position_vb": "186eac84",
        "draw_vb": "796a33a2",
        "new_ib": "531d9358",
        "new_draw_vb": "",
        "path": "./PlayerCharacterData/Childe/hash.json",
        ...
        "old_ib": "44bb03ab",
        "texcoord_vb": "739488d9",
        "blend_vb": "aa767fbd",
        "position_vb": "be10d76a",
        "draw_vb": "f9a96839",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./PlayerCharacterData/Clorinde/hash.json",
        "folder": "./PlayerCharacterData/Clorinde",
        "component_name": "",
        "name": "Clorinde"
    }, {
        "old_ib": "05729218",
        "texcoord_vb": "1b2f9d1b",
        "blend_vb": "e5fe748c",
        "position_vb": "348e58c4",
        "draw_vb": "d90dae49",
        "new_ib": "3da6f8c7",
        ...
        "folder": "./PlayerCharacterData/Furina",
        "component_name": "",
        "name": "Furina"
    }, {
        "old_ib": "669be7b7",
        "texcoord_vb": "a72fe835",
        "blend_vb": "e4a4630a",
        "position_vb": "2a47d8de",
        "draw_vb": "12c26e65",
        "new_ib": "5e4f8d68",
        "new_draw_vb": "",
        "path": "./PlayerCharacterData/Furina/hash.json",
        ...
        "old_ib": "3ffb839e",
        "texcoord_vb": "71935fca",
        "blend_vb": "1855ae41",
        "position_vb": "7d0eb8c9",
        "draw_vb": "c32376aa",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./PlayerCharacterData/Sigewinne/hash.json",
        "folder": "./PlayerCharacterData/Sigewinne",
        "component_name": "",
        "name": "Sigewinne"
    }, {
        "old_ib": "3e3c00b7",
        "texcoord_vb": "c43b5b80",
        "blend_vb": "52230792",
        "position_vb": "b655c335",
        "draw_vb": "75e2c70c",
        "new_ib": "06e86a68",
        ...
        "old_ib": "a6b6de38",
        "texcoord_vb": "f7242288",
        "blend_vb": "9f5dc53b",
        "position_vb": "aa6f1268",
        "draw_vb": "1d3faf44",
        "new_ib": "9e62b4e7",
        "new_draw_vb": "",
        "path": "./PlayerCharacterData/Wriothesley/hash.json",
        "folder": "./PlayerCharacterData/Wriothesley",
        "component_name": "",
        "name": "Wriothesley"
    }, {
        "old_ib": "496a6d62",
        "texcoord_vb": "edf572dd",
        "blend_vb": "3113b264",
        "position_vb": "c351ac3a",
        "draw_vb": "19d2ff67",
        "new_ib": "71be07bd",
        "new_draw_vb": "",
        "path": "./PlayerCharacterData/Wriothesley/hash.json",
        "folder": "./PlayerCharacterData/Wriothesley",
        "component_name": "Jacket",
        "name": "Wriothesley"
    }, {
        "old_ib": "5363ff5d",
        "texcoord_vb": "29744879",
        "blend_vb": "2b663556",
        "position_vb": "9427917d",
        "draw_vb": "1db7148c",
        "new_ib": "6bb79582",
        ...
        "folder": "./SkillData/BarbatosHolyLyre",
        "component_name": "",
        "name": "BarbatosHolyLyre"
    }, {
        "old_ib": "3180aa0c",
        "texcoord_vb": "71337960",
        "blend_vb": "5b655a0a",
        "position_vb": "6251a4f6",
        "draw_vb": "1111f982",
        "new_ib": "0954c0d3",
        ...
        "old_ib": "2c3e285e",
        "texcoord_vb": "f07c22d8",
        "blend_vb": "62410140",
        "position_vb": "38a48abd",
        "draw_vb": "c698ab79",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./SkillData/CynoWolfMask/hash.json",
        ...
        "old_ib": "10572338",
        "texcoord_vb": "56f15d74",
        "blend_vb": "1192a14f",
        "position_vb": "887e7fe3",
        "draw_vb": "20fe5648",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./SkillData/CynoWolfMask/hash.json",
        ...
        "folder": "./SkillData/IceSongofBrokenPines",
        "component_name": "",
        "name": "IceSongofBrokenPines"
    }, {
        "old_ib": "5e1761ff",
        "texcoord_vb": "",
        "blend_vb": "",
        "position_vb": "96375fdd",
        "draw_vb": "96375fdd",
        "new_ib": "5e1761ff",
        "new_draw_vb": "",
        "path": "./SkillData/IceSongofBrokenPines/hash.json",
        ...
        "folder": "./WeaponData/Bows/4Star/MitternachtWaltz",
        "component_name": "",
        "name": "MitternachtWaltz"
    }, {
        "old_ib": "a4120119",
        "texcoord_vb": "ea6525dc",
        "blend_vb": "f7f0ddd2",
        "position_vb": "62b27805",
        "draw_vb": "3782b39a",
        "new_ib": "9cc66bc6",
        ...
        "folder": "./WeaponData/Catalysts/3Star/ThrillingTalesOfDragonSlayer",
        "component_name": "",
        "name": "ThrillingTalesOfDragonSlayer"
    }, {
        "old_ib": "2d35e411",
        "texcoord_vb": "19654661",
        "blend_vb": "60b64e72",
        "position_vb": "a15deee9",
        "draw_vb": "f34fc1e9",
        "new_ib": "15e18ece",
        ...
        "folder": "./WeaponData/Catalysts/4Star/FuitOfFultilment",
        "component_name": "",
        "name": "FuitOfFultilment"
    }, {
        "old_ib": "7c388d69",
        "texcoord_vb": "edc8a74a",
        "blend_vb": "5d646ea7",
        "position_vb": "4ec23e4a",
        "draw_vb": "4a38c9bb",
        "new_ib": "44ece7b6",
        ...
        "old_ib": "c1975d7e",
        "texcoord_vb": "494ce78f",
        "blend_vb": "18f7d51e",
        "position_vb": "809f7fff",
        "draw_vb": "d4f9c0b4",
        "new_ib": "b3ea9991",
        "new_draw_vb": "",
        "path": "./WeaponData/Catalysts/4Star/SolarPearl/hash.json",
        ...
        "folder": "./WeaponData/Claymores/NonPlayer/IttoTaurusClaymore",
        "component_name": "",
        "name": "IttoTaurusClaymore"
    }, {
        "old_ib": "cfd98554",
        "texcoord_vb": "35222cab",
        "blend_vb": "82926c82",
        "position_vb": "c3c9ccbc",
        "draw_vb": "9c289a2d",
        "new_ib": "",
        ...
        "folder": "./WeaponData/Enemies/HilicurlRangerHydroScythe",
        "component_name": "",
        "name": "HilicurlRangerHydroScythe"
    }, {
        "old_ib": "0dcfcb00",
        "texcoord_vb": "",
        "blend_vb": "",
        ...
        "texcoord_vb": "",
        "blend_vb": "",
        "position_vb": "2a527815",
        "draw_vb": "2a527815",
        "new_ib": "0e69854d",
        "new_draw_vb": "",
        "path": "./WeaponData/Swords/4Star/AlleyFlash/hash.json",
        "folder": "./WeaponData/Swords/4Star/AlleyFlash",
        "component_name": "",
        "name": "AlleyFlash"
    }, {
        "old_ib": "0e69854d",
        ...
        "texcoord_vb": "",
        "blend_vb": "",
        "position_vb": "aaedc302",
        "draw_vb": "aaedc302",
        "new_ib": "",
        "new_draw_vb": "",
        "path": "./WeaponData/Swords/NonPlayer/Dehya'sFather'sCane/hash.json",
        "folder": "./WeaponData/Swords/NonPlayer/Dehya'sFather'sCane",
        "component_name": "Knife",
        "name": "Dehya'sFather'sCane"
    }, {
        "old_ib": "eb99ac83",
        "texcoord_vb": "",
        "blend_vb": "",
        ...
        "folder": "",
        "component_name": "",
        "name": "thundercravenrifthoundwhelp"
    }, {
        "old_ib": "72fce93f",
        "texcoord_vb": "",
        "blend_vb": "",
        ...
        "folder": "",
        "component_name": "",
        "name": "EremiteScorchingLoremaster"
    }, {
        "old_ib": "c210d17d",
        "texcoord_vb": "",
        "blend_vb": "",
        ...
        "folder": "",
        "component_name": "",
        "name": "Ayaka Springbloom Missive"
    }, {
        "old_ib": "5594b4bb",
        "texcoord_vb": "",
        "blend_vb": "",
